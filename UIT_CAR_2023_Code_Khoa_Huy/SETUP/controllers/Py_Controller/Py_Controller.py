...
def DeterminePosition(filted):
    ...
    elif filted in [0b00001110, 0b00011111, 0b00001111, 0b00000111, 0b00011110, 0b00111110]:
        return re_phai
    elif filted in [0b01110000, 0b11111000, 0b11110000, 0b11100000, 0b01111000, 0b01111100]:
        return re_trai
