...
while robot.step(TIME_STEP) != -1:
    ...
    if pos == chinh_giua and e != 0:
        ...
        i = 0
        h = 0
    elif pos == lech_phai4 and c == 0 and i == 0 and f == 0 and m != 0 and u == 0:
        re_trai()
        z = z + 1
        m = 0
        o = 0
    elif pos == lech_trai4 and f == 0 and i == 0 and c == 0 and n != 0 and u == 0:
        re_phai()
        ab = ab + 1
        n = 0
        o = 0
        ...
        di_thang()
    elif pos == full_den and a == 0 and b == 0 and c == 0 and f == 0 and g == 0 and h == 0 and dis == 1000 and r == 0 and u == 0 and z != 0:
        re_trai()
    elif pos == full_den and a == 0 and b == 0 and c == 0 and f == 0 and g == 0 and h == 0 and dis == 1000 and r == 0 and u == 0 and ab != 0:
        re_phai()
